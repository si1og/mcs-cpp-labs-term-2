...
int main()
{
    ...
    // {
    //     Rect r1; //Вызван Rect(): 0x7fffffffdc30
    //     Rect *pR = new Rect(1,2,1,2); //Вызван Rect(int, int, int, int): 0x55555556b6c0 
    //     {
    //         Rect r2(r1); //Вызван Rect(const Rect): 0x7fffffffdc40
    //         Rect arRect[2];
    //         // Вызван Rect(): 0x7fffffffdc70
    //         // Вызван Rect(): 0x7fffffffdc80
    //         for(int i = 0; i < 3; i++)
    //         {
    ...
    //             Rect r5(i,i,i,i);
    //             //i = 0
    //             // Вызван Rect(int, int, int, int): 0x5555555581a0
    //             // Вызван Rect(const Rect): 0x7fffffffdc50
    //             // Вызван Rect(int, int, int, int): 0x7fffffffdc60
    //             // Вызван дестркутор класса Rect: 0x7fffffffdc60
    //             // Вызван дестркутор класса Rect: 0x7fffffffdc50
    ...
    //             // Вызван дестркутор класса Rect: 0x7fffffffdc50
    //         }
    //         // Вызван дестркутор класса Rect: 0x7fffffffdc80
    //         // Вызван дестркутор класса Rect: 0x7fffffffdc70
    //         // Вызван дестркутор класса Rect: 0x7fffffffdc40
    //     }
    //     delete pR;  
    //     // Вызван дестркутор класса Rect: 0x55555556b6c0
    //     // Вызван дестркутор класса Rect: 0x7fffffffdc30
    //     // Вызван дестркутор класса Rect: 0x5555555581a0
    // }
    ...
    {
        // Rect r1;
        // // Calling a private constructor of class 'Rect'clang(access_ctor)
        // // rect.hpp(4, 9): Declared private here
        // // Variable of type 'Rect' has private destructorclang(access_dtor_var)
        // // rect.hpp(11, 9): Declared private here
        // std::cout << r1.left << std::endl;
        // // 'left' is a private member of 'Rect'clang(access)
        // // rect.hpp(7, 13): Declared private here
    }
    ...
    //     cout << "Текущая ширина: " << r.get_width() << "\n";
    //     cout << "Текущая вытота: " << r.get_height() << "\n";
    //     cout << "Текущая площадь: " << r.get_square() << "\n";
    ...
    {
        Barrel alch(100, 0.96); 
        Barrel water(100, 0.0); 
    
        int iteration = 0;
        while (alch.getConcentration() > 0.5) {
            
            alch.pourInto(water, 2);
            water.pourInto(alch, 2);
            iteration++;
        }
    
        cout << "Номер итерации: " << iteration << "\n";
    }
...

    {
        ...
        // Matrix fib_matrix(2,2,0);
        // for (int i = 0; i < 2; ++i) {
        //     for (int j = 0; j < 2; j++) fib_matrix.set(i, j, transform_matrix[i][j]);
        // }

        // Matrix fib_vector(2,1,0);
        // fib_vector.set(0,0,1);
        // fib_vector.set(1,0,0);

        // for (int i = 0; i < 40; ++i) {
        //     cout << fib_vector.get(1,0) << " ";
        //     Matrix result(fib_matrix.multiply(fib_vector));
        //     fib_vector.copy(result);
        // }
        // cout << endl;
    }
